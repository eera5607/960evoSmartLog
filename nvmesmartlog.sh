...
then
echo -e "Temperature 2 is ${COLOR1}$TEMP2UNITS celsius${NC} and is between the correct working range."
else
echo -e "Temperature 2 is ${COLOR2}$TEMP2UNITS celsius${NC} and is outside the correct working range."
fi 
